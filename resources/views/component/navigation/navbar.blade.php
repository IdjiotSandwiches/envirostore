        ...
        <div class="items-center justify-between md:flex w-auto md:order-2">
            ...
            @else
                ...
                <div class="flex justify-center items-center gap-2">
                    <a href="{{ route('login') }}" class="text-white bg-button hover:bg-button/80 focus:ring-4 focus:outline-none focus:ring-button/15 font-medium rounded-lg text-md px-4 md:px-5 py-1.5 md:py-2 dark:bg-button dark:hover:bg-button/80 dark:focus:ring-button/15 text-nowrap">Login</button>
